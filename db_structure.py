...
def apply_database_structure():
    ...
    check_admin_user = """
    SELECT EXISTS (SELECT 1 FROM users WHERE email = 'admin@learny.app');
    """
    ...
    if not success:
        ...
        if "f" in output:  # PostgreSQL devuelve 't' para true y 'f' para false
            ...
            VALUES ('admin@learny.app', '$2b$12$8VK5NL.wBV.LD9kx9Ulhme/R/M.QyD1m9F/FA8qSh5CH3kB3CzKJi', 'Admin User', true, true, 1000, CURRENT_TIMESTAMP);
            """
