  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Typography paragraph>
        Welcome to MapMyLearn (hereinafter, "the Service" or "the Platform"), an application designed to generate personalized courses using artificial intelligence. These Terms and Conditions (hereinafter, "T&C") govern the access and use of the Platform by users (hereinafter, "User" or "Users").
      </Typography>
      <Typography paragraph>
      ...
      <Typography paragraph>
        MapMyLearn is a platform that uses advanced language models and web search capabilities to generate structured courses on various topics requested by the User. The Service includes:
      </Typography>
      <List dense>
          <ListItem><ListItemText primary="Generation of courses with modules and submodules." /></ListItem>
          <ListItem><ListItemText primary="Personalization based on the topic and optional parameters provided by the User." /></ListItem>
          <ListItem><ListItemText primary="Storage of the history of generated courses for registered Users." /></ListItem>
      ...
      <Typography paragraph>
       ...
       <List dense>
          <ListItem><ListItemText primary="The courses and audios generated by the AI are the result of an automated process based on User input and public information sources and/or AI models." /></ListItem>
          <ListItem><ListItemText primary="The User receives a limited, non-exclusive, revocable, and non-transferable license to use the generated courses and audios solely for their personal and non-commercial learning." /></ListItem>
      ...
      <Typography variant="h5" component="h2" gutterBottom sx={{ mt: 3 }}>
       ...
       <List dense>
        <ListItem sx={{ pl: 2 }}><ListItemText primary="Usage: Certain actions within the Platform, such as generating courses (1 credit) or generating audio for submodules (1 credit), consume credits. The credit cost of each action will be indicated in the interface before performing it." /></ListItem>
